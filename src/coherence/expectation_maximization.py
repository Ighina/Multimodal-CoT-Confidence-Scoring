...
def compute_em_fused_embeddings_only(
    ...
    Args:
        ...
        covariance_type: Covariance shape passed to sklearn's GaussianMixture.
                          One of "full", "tied", "diag", "spherical". Use "diag"
                          (or "spherical") for tractability when fusing many
                          features.
